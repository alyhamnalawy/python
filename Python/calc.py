...
input_field = tk.Entry(input_frame, font=('italic',20, 'bold'), textvariable = display_text, width=50, bg="#eee", bd=0, justify=tk.RIGHT)
 
input_field.grid(row=0, column=0)
 
input_field.pack(ipady=10) 
 
btns_frame = tk.Frame(win, width=312, height=272.5, bg="blue")
 
btns_frame.pack()

 
clear_btn = tk.Button(btns_frame, text = "C", fg = "red", width = 32, height = 3, bd = 0, bg = "#eee", cursor = "hand2", command = lambda: clear_button_action()).grid(row = 0, column = 0, columnspan = 3, padx = 1, pady = 1)
